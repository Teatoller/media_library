...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $mail->Username = "steven.otieno1@gmail.com";
        //Password to use for SMTP authentication
        $mail->Password = "lnrftrpoafnmymsk";
        ...
        $mail->setFrom('steven.otieno1@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('steven.otieno1@gmail.com', 'Steven Ennis');
    ...
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            ...
            if (isset($error_message)) {
                ...
                echo '<p>Complete the form and send me an email, if you think there is something I am missing</p>';
            }
            ?>
                    ...
                    <tr>
                        ...
                        <td><select name="category" id="category">
                                ...
                                <option value="Books" <?php
                                                            if (isset($category) && $category == 'Books') echo " selected"; ?>>Book</option>
                                <option value="Movies" <?php
                                                            if (isset($category) && $category == 'M') echo " selected"; ?>>Movie</option>
                                <option value="Music" <?php
                                                            if (isset($category) && $category == 'Music') echo " selected"; ?>>Movies</option>
                            </select></td>
                    </tr>
                    <tr>
